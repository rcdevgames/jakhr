                    ...
                    {!isCollapsed && (
                        <form className="form mb-3">
                            <div className="row">
                                ...
                                <div className="col-md-6 col-12">
                                    <div className="form-group">
                                        <input type="number" className="form-control" placeholder="Jumlah"/>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-6 col-12">
                                    <div className="form-group">
                                        <input type="number" className="form-control" placeholder="Diangsur dalam"/>
                                    </div>
                                </div>
                                <div className="col-md-6 col-12">
                                    <div className="form-group">
                                        <input type="number" className="form-control" placeholder="Mulai angsuran ke"/>
                                    </div>
                                </div>
