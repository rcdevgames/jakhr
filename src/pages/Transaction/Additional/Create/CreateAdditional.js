                                        ...
                                        {rows.map((row, index) => (
                                            <tr key={index}>
                                                ...
                                                <td style={{minWidth:'100px'}}>
                                                    <select className="form-select" required>
                                                        <option></option>
                                                        <option value="regular">THR</option>
                                                        <option value="special">Insentif Saldo Cuti</option>
                                                    </select>
                                                ...
                                                <td style={{minWidth:'200px'}}>
                                                    <select className="form-select" required>
                                                        <option></option>
                                                        <option value="regular">Didalam Slip Gaji</option>
                                                        <option value="special">Diluar Slip Gaji</option>
                                                    </select>
                                                </td>
