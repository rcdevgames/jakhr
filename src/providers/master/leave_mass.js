...
export const getData = async (page = 1,limit=10,search="") => {
  try {
    const response = await sys_get({
      auth: true,
      endpoint: uri + `leave_masses?page=${page}&perPage=${limit}&search=${search}`,
    });
    return response;
  } catch (error) {
    throw error;
...
export const getDetail = async (id) => {
  try {
    const response = await sys_get({
      auth: true,
      endpoint: uri + `detail_leave_mass/${id}`,
    });
...
export const insertData=async (body={})=>{
  try {
    const response = await sys_post({
      auth:true,
      body,
      endpoint:uri+"create_leave_mass"
    });
    return response;
  } catch (error) {
    throw error;
...
export const updateData=async (body={},id="")=>{
  try {
    const response = await sys_put({
      auth:true,
      body,
      endpoint:uri+"update_leave_mass/"+id
    });
    return response;
  } catch (error) {
    throw error;
...
export const deleteData= async(id="")=>{
  try {
    const response = await sys_del({auth:true,endpoint:uri+`delete_leave_mass/${id}`});
    return response;
  } catch (error) {
    throw error
  }
