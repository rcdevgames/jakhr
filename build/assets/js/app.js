...
var Sidebar = /*#__PURE__*/function () {
  ...
  _createClass(Sidebar, [{
    ...
    value: function init() {
      ...
      //       if (submenu.classList.contains("d-none"))  {submenu.classList.remove("d-none");submenu.classList.add("d-block");} else {submenu.classList.add("d-none");submenu.classList.remove("d-block")}
      //     },300)
      //     slideToggle(submenu, 300, function () {
      //       return _this.forceElementVisibility(sidebarItem);
      //     });
